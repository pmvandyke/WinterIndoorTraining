 ...
 class RunWorkout  extends Frame{
	...
	long currentTime;
	long newTime;
	//String inputFileName = "Session 1.1 Fundementals.txt";
	...
	public RunWorkout() {
		...
		jtfSession.setText(inputFileName);
...
//System.out.println ("Call to wait interrupted: ");
													//}
												//}
											//}	
											decrementTaskTime ();
		...
		jcbPause.addItemListener (new ItemListener (){
			public void itemStateChanged(ItemEvent ie){
				if (jcbPause.isSelected()){
					System.out.println("Pause was selected " );
					//suspendFlag = true;
				}
				else{
					System.out.println("Pause was de selected " );
					//suspendFlag = false;
					//notify();
				}
			}		
