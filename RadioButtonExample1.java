...
import javax.swing.JOptionPane;
 ...
 public class RadioButtonExample1 extends JPanel implements ActionListener{
	...
	public RadioButtonExample1() {
		...
		group.add(new JRadioButton("oneButton", true));
		group.add(new JRadioButton("twoButton", true));
		//group.add(oneButton);
		//group.add(twoButton);
	...
	public void actionPerformed(ActionEvent e){
		...
		//---------------------------------------------------------------------------
		//	answer = Integerparse(JOptionPane.showMessageDialog(null, message, 
	...
	public static void createAndShowGUI(){
		...
		JComponent newContentPane = new RadioButtonExample1();
